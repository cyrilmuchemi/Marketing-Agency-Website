...
const ClientsList = () => {
  ...
  return (
    <div>
      <div className="bg-primary h-44 rounded-b-full sm:rounded-b-2xl" />
      <div className="flex justify-center sm:space-x-0 sm:p-5 -mt-44 items-end space-x-10">
        {selectedClientIndex !== 0 && <i className="ri-arrow-left-fill sm:hidden text-4xl text-gray-600 cursor-pointer" onClick={previous} />}
        ...
        {selectedClientIndex < 4 && <i className="ri-arrow-right-fill sm:hidden text-4xl text-gray-600 cursor-pointer" onClick={next} />}
      </div>
